...
static const yytype_int16 yyrline[] =
{
     ...
     156,   162,   163,   170,   190,   191,   192,   193,   196,   201,
     202,   212,   213,   214,   217,   218,   219,   220,   223,   224,
     227,   228,   229,   230,   231,   232,   236,   237,   240,   241,
     242,   243,   246,   247,   248,   251,   252,   253,   256,   257,
     258,   259,   260,   263,   264,   265,   268,   269,   272,   273,
     276,   277,   278,   281,   285,   286
};
#endif
...
#line 1516 "miniC_parser.cpp"
  ...
  case 40: /* for_statement: TK_FOR '(' expression_statement expression_statement expression ')' statement  */
#line 156 "miniC.y"
                                                                                            {
    (yyval.statement_t) = new ForStatement((yyvsp[-4].statement_t),(yyvsp[-3].statement_t),(yyvsp[-2].expr_t),(yyvsp[0].statement_t),yylineno);
    delete (yyvsp[-4].statement_t);
}
#line 1525 "miniC_parser.cpp"
    break;

  case 42: /* expression_statement: expression ';'  */
#line 164 "miniC.y"
                    {
...
#line 1534 "miniC_parser.cpp"
  ...
  case 43: /* while_statement: TK_WHILE '(' expression ')' statement  */
#line 170 "miniC.y"
                                                      { 
